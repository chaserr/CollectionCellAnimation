...
//
//  https://github.com/nicklockwood/BlurView
//
...
- (void)setBlurEnabled:(BOOL)blurEnabled
{
    ...
    if (blurEnabled)
    {
        for (BlurView *view in self.views)
        {
...
+ (void)setBlurEnabled:(BOOL)blurEnabled
{
    [BlurScheduler sharedInstance].blurEnabled = blurEnabled;
}

+ (void)setUpdatesEnabled
{
    [[BlurScheduler sharedInstance] setUpdatesEnabled];
}

+ (void)setUpdatesDisabled
{
    [[BlurScheduler sharedInstance] setUpdatesDisabled];
}
...
{
    BlurLayer *blurLayer = [self blurLayer];
...
- (void)schedule
{
    ...
    {
        [[BlurScheduler sharedInstance] addView:self];
    }
    else
    {
        [[BlurScheduler sharedInstance] removeView:self];
    }
}
...
- (BOOL)shouldUpdate
{
    ...
    self.blurEnabled && [BlurScheduler sharedInstance].blurEnabled &&
...
- (UIImage *)snapshotOfUnderlyingView
{
    __strong BlurLayer *blurLayer = [self blurPresentationLayer];
    __strong CALayer *underlyingLayer = [self underlyingLayer];
